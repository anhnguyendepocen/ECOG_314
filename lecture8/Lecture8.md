...
```
    ...
    OUTPUT>  
    OUTPUT>  Attaching package: 'dplyr'

    OUTPUT>  The following objects are masked from 'package:xts':
    OUTPUT>  
    OUTPUT>      first, last

    OUTPUT>  The following objects are masked from 'package:stats':
    OUTPUT>  
    OUTPUT>      filter, lag

    OUTPUT>  The following objects are masked from 'package:base':
    OUTPUT>  
    OUTPUT>      intersect, setdiff, setequal, union
